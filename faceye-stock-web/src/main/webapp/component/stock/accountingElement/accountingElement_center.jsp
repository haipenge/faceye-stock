...
<div class="page-head">
	<h2>
		...
		<a class="btn btn-primary" href="<c:url value="/stock/accountingElement/input"/>"> <fmt:message
				key="stock.accountingElement.add"></fmt:message>
		</a>
	</h2>
</div>
<div class="cl-mcont">
	...
	<div class="block-flat">
		<div class="content">
			<form action="<c:url value="/stock/accountingElement/home"/>" method="post" role="form"
						...
						<c:forEach items="${page.content}" var="accountingElement">
							<tr>
							   <td><input type="checkbox" name="check-single" value="${accountingElement.id}"></td>
								...
								<td><a href="<c:url value="/stock/accountingElement/edit/${accountingElement.id}"/>">
										<fmt:message key="global.edit"></fmt:message>
								</a></td>
								<td><a href="<c:url value="/stock/accountingElement/remove/${accountingElement.id}"/>">
