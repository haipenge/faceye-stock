...
<div class="page-head">
	<h2>
		...
		<a class="btn btn-primary" href="<c:url value="/stock/reportCategory/input"/>"> <fmt:message
				key="stock.reportCategory.add"></fmt:message>
		</a>
	</h2>
</div>
<div class="cl-mcont">
	...
	<div class="block-flat">
		<div class="content">
			<form action="<c:url value="/stock/reportCategory/home"/>" method="post" role="form"
						...
						<c:forEach items="${page.content}" var="reportCategory">
							<tr>
							   <td><input type="checkbox" name="check-single" value="${reportCategory.id}"></td>
								...
								<td><a href="<c:url value="/stock/reportCategory/edit/${reportCategory.id}"/>">
										<fmt:message key="global.edit"></fmt:message>
								</a></td>
								<td><a href="<c:url value="/stock/reportCategory/remove/${reportCategory.id}"/>">
