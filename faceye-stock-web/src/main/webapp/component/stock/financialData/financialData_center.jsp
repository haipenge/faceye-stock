...
<div class="page-head">
	<h2>
		...
		<a class="btn btn-primary" href="<c:url value="/stock/financialData/input"/>"> <fmt:message
				key="stock.financialData.add"></fmt:message>
		</a>
	</h2>
</div>
<div class="cl-mcont">
	...
	<div class="block-flat">
		<div class="content">
			<form action="<c:url value="/stock/financialData/home"/>" method="post" role="form"
						...
						<c:forEach items="${page.content}" var="financialData">
							<tr>
							   <td><input type="checkbox" name="check-single" value="${financialData.id}"></td>
								...
								<td><a href="<c:url value="/stock/financialData/edit/${financialData.id}"/>">
										<fmt:message key="global.edit"></fmt:message>
								</a></td>
								<td><a href="<c:url value="/stock/financialData/remove/${financialData.id}"/>">
