	...
	<div class="row">
		...
		<div class="col-sm-7 text-center">
		   <c:if test="${not empty dailyStat }">
				...
				波动幅度: <font class="${price-css }"><c:if test="${dailyStat.topPriceDate lt dailyStat.lowPriceDate }">-</c:if>&nbsp;&nbsp;<fmt:formatNumber value="${100* ( dailyStat.topPriceOf30Day - dailyStat.lowPriceOf30Day )/dailyStat.lowPriceOf30Day}" type="number" pattern="#,##0.0#" maxFractionDigits="2" groupingUsed="true" />%</font>
				</c:if>
		</div>
