						...
						<c:forEach items="${page.content}" var="stock">
							<tr id="${stock.id }">
								<td><input type="checkbox" name="check-single"
									value="${stock.id}"></td>
								<td><a href="<c:url value="/stock/stock/stockBoard?stockId=${ stock.id}"/>">${stock.name}</a>&nbsp;&nbsp;<small>(<a
								...
								<td><a href="#" class="super-stock-data-init">初始化</a>|
								<a
									href="<c:url value="/stock/reportData/report?stockId=${stock.id}"/>">财报</a>|
								<a
