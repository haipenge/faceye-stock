				...
				<table class="table table-bordered table-hover">
					<thead>
						<tr>
							...
							<th>当前股价</th>
							<th><a href="<c:url value="/stock/stock/home?EQ|category.$id=${searchparams.categoryid}&GTE|dailyStat.pe=${searchParams.minPe }&LTE|dailyStat.pe=${searchParams.maxPe}&like|name=${searchParams.name }&like|code=${searchParams.code}&SORT|dailyStat.pe=${empty sortPe or sortPe eq 'asc' ? 'desc':'asc' }"/>">PE ${empty sortPe or sortPe eq 'desc'? '<i class="fa fa-chevron-circle-up"></i>':'<i class="fa fa-chevron-circle-down"></i>' }</a></th>
							<th>PB</th>
							<th><a href="<c:url value="/stock/stock/home?EQ|category.$id=${searchparams.categoryid}&GTE|dailyStat.pe=${searchParams.minPe }&LTE|dailyStat.pe=${searchParams.maxPe}&like|name=${searchParams.name }&like|code=${searchParams.code}&SORT|dailyStat.todayIncreasePrice=${empty sortTodayIncreasePrice or sortTodayIncreasePrice eq 'asc' ? 'desc':'asc' }"/>">今日涨跌</a></th>
