...
$MONGO_DIR/bin/mongoimport -d search -c stock_stock $EXPORT_DIR/stock_stock.bak
$MONGO_DIR/bin/mongoimport -d search -c stock_category $EXPORT_DIR/stock_category.bak