...
#MONGO_DIR=/tools/mongodb/mongodb-osx-x86_64-enterprise-3.6.3
MONGO_DIR=/usr/local/mongo/mongodb-linux-x86_64-ubuntu1604-3.6.3
...
EXPORT_DIR=/home/haipenge/project/faceye-stock/faceye-stock-manager/data/db
