...
<script type="text/javascript" src="<c:url value="/js/component/stock/financialReport/financialReport.js"/>"></script>
<div class="page-head">
	<h2>
		<fmt:message key="stock.financialReport.manager"></fmt:message>
		<a class="btn btn-primary" href="<c:url value="/stock/financialReport/input"/>"> <fmt:message key="stock.financialReport.add"></fmt:message>
		</a>
	</h2>
</div>
<div class="cl-mcont">
				...
				<table class="table table-bordered">
					<thead>
						<tr>
							...
							<th><fmt:message key='stock.financialReport.name'></fmt:message></th>
							<th><fmt:message key='stock.financialReport.date'></fmt:message></th>
					...
					<tbody>
						<c:forEach items="${page.content}" var="financialReport">
							<tr>
								...
								<td><a href="<c:url value="/stock/financialReport/edit/${financialReport.id}"/>"> <fmt:message key="global.edit"></fmt:message>
								</a></td>
								<td><a href="<c:url value="/stock/financialReport/remove/${financialReport.id}"/>"> <fmt:message key="global.remove"></fmt:message>
								</a></td>
							<tr>
						</c:forEach>
					</tbody>
