...
<div class="col-md-1">
	<input type="text" name="EQ|name" value="${searchParams.name}"
		placeholder="<fmt:message key="crm.emplyee.name"></fmt:message>"
		class="form-control input-sm">
</div>

<div class="col-md-1">
	<input type="text" name="EQ|age" value="${searchParams.age}"
		placeholder="<fmt:message key="crm.emplyee.age"></fmt:message>"
		class="form-control input-sm">
</div>
					...
					<thead>
						<tr>
						   <th><input type="checkbox" name="check-all"></th>
							<th><fmt:message key='crm.emplyee.name'></fmt:message></th>   
 <th><fmt:message key='crm.emplyee.age'></fmt:message></th>   
