...
public class AccountingElementController extends BaseController<AccountingElement, Long, AccountingElementService> {
	...
	@RequestMapping("/home")
	@ResponseBody
	public Page<AccountingElement> home(HttpServletRequest request, Model model) {
	...
	@ResponseBody
	public AccountingElement detail(@PathVariable Long id,Model model){
		if(id!=null){
			AccountingElement accountingElement=this.service.get(id);
		}
