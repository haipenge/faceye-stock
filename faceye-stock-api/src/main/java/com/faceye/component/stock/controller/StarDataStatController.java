...
public class StarDataStatController extends BaseController<StarDataStat, Long, StarDataStatService> {
	...
	@RequestMapping("/home")
	@ResponseBody
	public Page<StarDataStat> home(HttpServletRequest request, Model model) {
	...
	@ResponseBody
	public StarDataStat detail(@PathVariable Long id,Model model){
		if(id!=null){
			StarDataStat starDataStat=this.service.get(id);
		}
		return starDataStat;
	}
