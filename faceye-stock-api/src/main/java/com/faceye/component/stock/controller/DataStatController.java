...
public class DataStatController extends BaseController<DataStat, Long, DataStatService> {
	...
	@RequestMapping("/home")
	@ResponseBody
	public Page<DataStat> home(HttpServletRequest request, Model model) {
	...
	@ResponseBody
	public DataStat detail(@PathVariable Long id,Model model){
		if(id!=null){
			DataStat dataStat=this.service.get(id);
		}
		return dataStat;
	}
