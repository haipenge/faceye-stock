...
public class FinancialDataController extends BaseController<FinancialData, Long, FinancialDataService> {
	...
	@RequestMapping("/home")
	@ResponseBody
	public Page<FinancialData> home(HttpServletRequest request, Model model) {
	...
	@ResponseBody
	public FinancialData detail(@PathVariable Long id,Model model){
		if(id!=null){
			FinancialData financialData=this.service.get(id);
		}
