...
public class FinancialReportController extends BaseController<FinancialReport, Long, FinancialReportService> {
	...
	@RequestMapping("/home")
	@ResponseBody
	public Page<FinancialReport> home(HttpServletRequest request, Model model) {
	...
	@ResponseBody
	public FinancialReport detail(@PathVariable Long id,Model model){
		if(id!=null){
			FinancialReport financialReport=this.service.get(id);
		}
