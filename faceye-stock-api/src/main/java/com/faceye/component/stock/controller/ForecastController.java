...
public class ForecastController extends BaseController<Forecast, Long, ForecastService> {
	...
	@RequestMapping("/home")
	@ResponseBody
	public Page<Forecast> home(HttpServletRequest request, Model model) {
	...
	@ResponseBody
	public Forecast detail(@PathVariable Long id,Model model){
		if(id!=null){
			Forecast forecast=this.service.get(id);
		}
		return forecast;
	}
