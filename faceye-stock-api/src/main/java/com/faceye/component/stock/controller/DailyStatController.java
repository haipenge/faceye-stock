...
public class DailyStatController extends BaseController<DailyStat, Long, DailyStatService> {
	...
	@RequestMapping("/home")
	@ResponseBody
	public Page<DailyStat> home(HttpServletRequest request, Model model) {
	...
	@ResponseBody
	public DailyStat detail(@PathVariable Long id,Model model){
		if(id!=null){
			DailyStat dailyStat=this.service.get(id);
		}
		return dailyStat;
	}
